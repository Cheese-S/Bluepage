        ...
        <body>
            ...
            <Box  width="100%" height="40%" sx={{  display: 'flex' }}>
                <Box width="50%" sx={{borderRight: 1 ,borderColor:"#3d63d4"}} >
                    <Button onClick={goToComic} variant='contained' sx={{backgroundColor:'#5227cc', pl:'10%',pr:'10%',pt:'2%',pb:'2%', ml:'30%',mt:'15%'}}><Typography variant="h6" align='center' sx={{color:'white', variant:'body1'}}>COMIC</Typography></Button>
                ...
                <Box width="50%">
                    <Button onClick={goToStory} variant='contained'sx={{backgroundColor:'#d52941',pl:'10%',pr:'10%',pt:'2%',pb:'2%', ml:'30%',mt:'15%'}}><Typography variant="h6" align='center' sx={{color:'white', variant:'body1'}}>STORY</Typography></Button>
